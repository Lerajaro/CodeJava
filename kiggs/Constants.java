...
public class Constants {
    ...
    public static final String OUTPUT_DIRECTORY = "kiggs/testproducts/"; // Output-directory for precise analysis of each iteration
    public static final String ANALYSIS_FOLDER = "kiggs/risk-analysis/";
